...
import pl.wbsoft.exceptions.InvalidPesel;
...
public class Pesel {
    ...
    public int getSex() {
        return (peselBytes[9] % 2);
    }

    public boolean isAdult() throws InvalidPesel {
        return getBirthDate().plusYears(ADULT_ADGE).isBefore(LocalDate.now());
    }
